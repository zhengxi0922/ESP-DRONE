...
#define CONSOLE_PROTOCOL_VERSION 0x0Au
...
#define CONSOLE_FEATURE_STABILIZE_MIN (1u << 11)
#define CONSOLE_FEATURE_PREFLIGHT_CHECK (1u << 12)
#define CONSOLE_FEATURE_BITMAP_CURRENT \
    (CONSOLE_FEATURE_PARAMS | \
     ...
     CONSOLE_FEATURE_STABILIZE_MIN | \
     CONSOLE_FEATURE_PREFLIGHT_CHECK)
