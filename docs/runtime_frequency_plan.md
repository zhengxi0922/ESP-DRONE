...
**Language / 语言：** **English** | [简体中文](./runtime_frequency_plan.zh-CN.md)
...
These limits match the current bring-up scope and keep the binary CDC or UDP telemetry load within the intended safe range for bench testing.
...
- a fresh-sample estimator and rate-update path
